...
class DBVRunnerTest {
  @Mock private DBVRunner dbvRunner;

  @InjectMocks private DatabaseValidationService databaseValidationService;
  ...
  void testDBVRunner_doesThrowException() {
    // Arrange
    doThrow(new SQLException("Database error")).when(dbvRunner).run();
